  ...
  return (
    <View>
      ...
      <ScrollView style={[{ opacity: opacityText, maxHeight:520, }]}>
        ...
        Thank you for requesting a feature. Your submission has been successfully received. Our support team will review your request and get back to you within 5 working days. For further assistance, you can contact us at support@example.com.
        </ThemedText>
      </ScrollView>
    </View>
  );
